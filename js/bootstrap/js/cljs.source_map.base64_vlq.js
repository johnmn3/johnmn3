...
var digit_17064 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_17065__$1 = (vlq >>> (5));
while(true){
if((vlq_17065__$1 > (0))){
var digit_17066__$1 = (digit_17064 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_17066__$1));

var G__17067 = (vlq_17065__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__17068 = (vlq_17065__$1 >>> (5));
digit_17064 = G__17067;
vlq_17065__$1 = G__17068;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_17064));
}
break;
}
...
var G__17112 = i__$1;
var G__17113 = result__$1;
var G__17114 = shift__$1;
i = G__17112;
result = G__17113;
shift = G__17114;
continue;
