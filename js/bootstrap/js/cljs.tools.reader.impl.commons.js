...
var G__16850 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__16850;
continue;
} else {
return ch;
...
var vec__16885 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16885,(0),null);
return (match === s);
});
...
var len__4531__auto___16917 = arguments.length;
var i__4532__auto___16918 = (0);
while(true){
if((i__4532__auto___16918 < len__4531__auto___16917)){
args__4534__auto__.push((arguments[i__4532__auto___16918]));

var G__16919 = (i__4532__auto___16918 + (1));
i__4532__auto___16918 = G__16919;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq16911){
...
return (function() { 
var G__16936__delegate = function (rdr,_){
...
var G__16936 = function (rdr,var_args){
var _ = null;
...
while (G__16942__i < G__16942__a.length) {G__16942__a[G__16942__i] = arguments[G__16942__i + 1]; ++G__16942__i;}
  _ = new cljs.core.IndexedSeq(G__16942__a,0,null);
} 
return G__16936__delegate.call(this,rdr,_);};
G__16936.cljs$lang$maxFixedArity = 1;
G__16936.cljs$lang$applyTo = (function (arglist__16946){
var rdr = cljs.core.first(arglist__16946);
var _ = cljs.core.rest(arglist__16946);
return G__16936__delegate(rdr,_);
});
