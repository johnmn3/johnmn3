...
var digit_30481 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_30482__$1 = (vlq >>> (5));
while(true){
if((vlq_30482__$1 > (0))){
var digit_30483__$1 = (digit_30481 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_30483__$1));

var G__30487 = (vlq_30482__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__30488 = (vlq_30482__$1 >>> (5));
digit_30481 = G__30487;
vlq_30482__$1 = G__30488;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_30481));
}
break;
}
...
var G__30491 = i__$1;
var G__30492 = result__$1;
var G__30493 = shift__$1;
i = G__30491;
result = G__30492;
shift = G__30493;
continue;
