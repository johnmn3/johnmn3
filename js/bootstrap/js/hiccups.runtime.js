...
var _STAR_html_mode_STAR_9310 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return (f.cljs$core$IFn$_invoke$arity$0 ? f.cljs$core$IFn$_invoke$arity$0() : f.call(null));
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_9310;
}});
/**
...
return [" ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccups.runtime.as_str(name)),"=\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccups.runtime.escape_html(value)),"\""].join('');
});
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__9339){
var vec__9344 = p__9339;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9344,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9344,(1),null);
if(value === true){
if(cljs.core.truth_(hiccups.runtime.xml_mode_QMARK_())){
return hiccups.runtime.xml_attribute(name,name);
} else {
return [" ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccups.runtime.as_str(name))].join('');
}
} else {
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__9392){
var vec__9400 = p__9392;
var seq__9401 = cljs.core.seq(vec__9400);
var first__9402 = cljs.core.first(seq__9401);
var seq__9401__$1 = cljs.core.next(seq__9401);
var tag = first__9402;
var content = seq__9401__$1;
if(!((((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))){
throw [cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)," is not a valid tag name"].join('');
} else {
}

var vec__9412 = cljs.core.re_matches(hiccups.runtime.re_tag,hiccups.runtime.as_str(tag));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9412,(0),null);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9412,(1),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9412,(2),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9412,(3),null);
...
var vec__9452 = hiccups.runtime.normalize_element(element);
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9452,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9452,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9452,(2),null);
...
return ["<",cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccups.runtime.render_attr_map(attrs)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hiccups.runtime.end_tag())].join('');
}
});
/**
